...
<div class="border flex flex-col rounded-md transition duration-75 p-0 h-full hover:border-accent cursor-pointer"
    ...
    <div class="px-6 pb-4 flex flex-col justify-between flex-1 gap-4">
        ...
        <div
            class="grid grid-cols-[2fr_1.5fr] gap-2 [&>p]:text-secondary [&>p>span]:text-primary py-2 gap-y-3 [&>p>span]:ml-4">
        ...
        <div class="mt-auto flex items-center justify-between gap-4 mb-1">
            ...
            <x-input type="number" input-class="quantity-input text-center h-14" placeholder="0" :value="$value"
